...
(eval-env '(arith-eval (cons '* (cons (cons '+ (cons 1 (cons 2 null)))
                                      (cons '+ (cons 3 (cons 4 null)))))) DoOddania)
(eval-env '(arith-eval (cons '/ (cons 2 (cons 4 null)))) DoOddania)
(eval-env '(arith-eval (cons '+ (cons 1 (cons 2 null)))) DoOddania)
;;po kolei operacje arytmetyczne
(eval-env '(arith-eval (cons '+ (cons 1 (cons 2 null)))) DoOddania)
(eval-env '(arith-eval (cons '* (cons 1 (cons 2 null)))) DoOddania)
(eval-env '(arith-eval (cons '- (cons 1 (cons 2 null)))) DoOddania)
(eval-env '(arith-eval (cons '/ (cons 1 (cons 2 null)))) DoOddania)
